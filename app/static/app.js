...
async function loadConversation(id){
  if(busy)return;const loadId=++conversationLoadSequence,started=performance.now();markConversationActive(id);messages.innerHTML='<div class="conversation-loading" aria-live="polite">Đang tải cuộc trò chuyện…</div>';
  try{
